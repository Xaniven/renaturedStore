...
export default function ItemComp(props) {
  return (
    <div
      key={props.key}
      className='card flex flex-col justify-center justify-items-center w-fit h-fit border-2 border-black m-2 rounded-lg'
    >
      ...
      <div className=' flex flex-col gap-2 bg-slate-400 rounded-lg text-left p-2 '>
        ...
        <button className='w-[100%] bg-green-700 hover:bg-green-800 py-2 mt-2 rounded-md'>
          Add to Cart
        </button>
      </div>
    </div>
