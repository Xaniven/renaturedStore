      ...
      <div className='left-side w-0 lg:w-[40vw] min-h-[155vh] lg:ml-8 lg:p-4 lg:m-6 flex-row justify-evenly z-20 lg:z-0'>
        ...
        <section className=' relative z-20 p-8 my-6 h-[fit] w-[96.5vw] lg:w-[60vw] shadow-2xl bg-slate-500 bg-opacity-80 border-green-800 border-4 rounded-2xl '>
          ...
          <p className='w-[45vw] text-xl'>
            Lorem ipsum dolor sit amet, consectetur adipisicing elit. Ea possimus quod eum molestias
            commodi ipsum quae dolorem dolore. Laudantium consequuntur natus accusantium minus
            possimus fugiat sint explicabo quas totam eum.
          </p>
        </section>
        <section className=' relative z-20 p-8 my-6 h-[fit] w-[96.5vw] lg:w-[60vw] shadow-2xl bg-slate-500 bg-opacity-80 border-green-800 border-4 rounded-2xl '>
          <h1 className=' text-4xl mb-8 z-20'>"Terp Brew" (Terpene Infused Coffees)</h1>
          <p className='w-[45vw] text-xl'>
            With both caffinated and decafe blends, we strive to bring somthing new to your morning
            coffee expirence. Terepene rich coffee add a new life to the flavour of your morning
            brew, bringing a bright way to start the day.
          </p>
        </section>
